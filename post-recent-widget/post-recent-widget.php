...
class recent_customer extends Widget_Base {
   ...
   public function __construct($data = [], $args = null)
  {
    ...
    wp_enqueue_style( 'post-recent-widget', plugin_dir_url( __DIR__  ) . '../css/deskspace/post-recent-widget.css','1.1.0');
  }
   ...
   public function get_style_depends() {
    ...
    <div class="main-post_grid main-post_grid_v1">
        <div class="post-grid_bar">
          <div class="grid-title">
            <h3><?php echo esc_html__( 'Blog', 'yp-core' ); ?><span><?php echo esc_html__( 'by Deskspace', 'yp-core' ); ?></span></h3>
          </div>
          <div class="btn-url">
              <a href="<?php echo get_home_url(); ?>/blog"><?php echo esc_html__( 'All Post', 'yp-core' ); ?><svg viewBox="0 0 24 24" width="24" height="24" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round" class="css-i6dzq1"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
          </div>
        </div>
    </div>
    <?php
    ...
    <div class="vc_posts card style-1 v1 post_grid">
